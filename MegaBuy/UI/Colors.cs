...
namespace MegaBuy.Temp
{
    ...
    {
        public static Color Primary = Color.FromNonPremultiplied(41, 98, 255, 214); //#2962ff
        public static Color General = Color.FromNonPremultiplied(41, 121, 255, 214); //#2979ff
