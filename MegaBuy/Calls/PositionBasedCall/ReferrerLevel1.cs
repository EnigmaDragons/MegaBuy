    ...
    public class ReferrerLevel1
    {
        ...
        private static readonly Func<Call>[] _calls = {
            ...
            () => {
                ...
                return new Call(new Caller(name, PatienceLevel.Impatient), script, CallResolution.ReferToInfo, RoleOptions);
            },
            () => {
                var name = CallerNames.Random;
                var script = new Script();
            ...
            () =>
            {
                ...
                script.Add(new ScriptLine(Player, "Hello " + name + ", how can I help you?"));
                script.Add(new ScriptLine(name, "How much can I sell my " + Products.Random + " for?"));
                return new Call(new Caller(name, PatienceLevel.VeryPatient), script, CallResolution.ReferToInfo, RoleOptions);
            },
            () =>
            {
                var name = CallerNames.Random;
                ...
                return new Call(new Caller(name, PatienceLevel.VeryImpatient), script, CallResolution.ReferToTroubleshooting, RoleOptions);
            },
            () =>
            {
                var name = CallerNames.Random;
                ...
                return new Call(new Caller(name, PatienceLevel.Patient), script, CallResolution.ReferToTroubleshooting, RoleOptions);
            },
            () =>
            {
                var name = CallerNames.Random;
                ...
                return new Call(new Caller(name, PatienceLevel.Impatient), script, CallResolution.ReferToTroubleshooting, RoleOptions);
            },
        };
