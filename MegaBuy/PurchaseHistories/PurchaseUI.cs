...
namespace MegaBuy.PurchaseHistories
{
    public class PurchaseUI : IVisual
    {
        ...
        public PurchaseUI(Purchase purchase)
        {
            ...
            AddLabel(5, 0, 5, 1, "12", HorizontalAlignment.Left, "Order DateTime: " + purchase.Date);
            ...
            AddLabel(2, 4, 2, 2, "12", HorizontalAlignment.Left, "Delivered DateTime: " + purchase.DeliverDateTime);
            AddLabel(4, 4, 34, 0, 2, 2, "14", HorizontalAlignment.Left, "Returned");
            AddLabel(6, 4, 2, 2, "12", HorizontalAlignment.Left, "Returned DateTime: " + purchase.ReturnDateTime);
